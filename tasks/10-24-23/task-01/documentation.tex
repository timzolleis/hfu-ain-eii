...
% aktuelles Datum einfuegen
    ...
    \begin{enumerate}
        ...
        \subitem 55 kann als 00110111 dargestellt werden und stehen gelassen werden
        \subitem 120 kann als 01111000 dargestellt werden, wird aber in das Zweierkomplement umgewandelt: 10001000
    \end{enumerate}
